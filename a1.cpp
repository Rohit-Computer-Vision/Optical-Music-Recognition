...
vector<DetectedSymbol> detectSymbols(SDoublePlane input_image,
...
int main(int argc, char *argv[]) {
	...
	SDoublePlane output_image = convolve_separable(input_image, row_filter,
			col_filter); // Uncomment Later
...
//******************** Q5 Sobel + separable kernel ***************************
	...
	SDoublePlane template_img_notehead = SImageIO::read_png_file(
			TEMPLATE_NOTEHEAD.c_str());

	vector<DetectedSymbol> symbols = detectSymbols(input_image,
			template_img_notehead);
